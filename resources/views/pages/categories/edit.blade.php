...
@section('title', 'Edit Kategori - JayMart')
    ...
    <div class="max-w-full bg-white rounded-xl card-shadow p-6">
        <form method="POST" action="{{ route('categories.update', $category) }}">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="category_name" value="{{ old('category_name', $category->category_name) }}" required class="w-full border rounded-lg px-3 py-2">
            </div>
